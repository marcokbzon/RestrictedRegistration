          ...
          <tr>
            <td>
              <table width="798" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td height="25px" colspan="4" class="print_section">&nbsp;Shifts By Service Type</td>
                </tr>
                <tr>
                  <td colspan="4">&nbsp;</td>
                </tr>
                <tr class="center">
                  <td colspan="4" class="center" width="700">
                    <h:dataTable id="table_shifts" value="#{shiftByServTypeBean.shiftDM}" var="sList"
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{sList.serviceTypeDesc}"/>
                      ...
                      <h:column>
                        ...
                        <f:facet name="footer"><h:outputText value="#{adminShiftsByServTypeReportRQ.totalShifts}" /></f:facet>
                      </h:column>

                      <h:column>
                        <f:facet name="header"><h:outputText value="Hours" /></f:facet>
                        <h:outputText value="#{sList.numberOfHours}"/>
                        <f:facet name="footer"><h:outputText value="#{adminShiftsByServTypeReportRQ.totalHours}" /></f:facet>
                      </h:column>
                    </h:dataTable>
                  </td>
                </tr>
