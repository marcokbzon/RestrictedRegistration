                ...
                <tr>
                  <td width="700" style="padding:10px;">
                    <table cellpadding="2" cellspacing="1" width="100%" style="border:0px;">
                      ...
                      <tr>
                        <td style="padding:0px 0px 20px 10px;">Comments about this application:<br />
                          <h:inputTextarea id="textarea_comments" rows="3" cols="100" style="width:550px;" styleClass="fldtxt" value="#{appReviewDean.comments}" />
                        </td>
                      </tr>
                      <%--tr>
                        <td style="padding:0px 0px 20px 10px;">Supporting documentation: <br /> ( select / deselect one or more documents by pressing the CTRL key )<br />
                          <h:selectManyListbox id="select_documents" styleClass="fld300" value="#{appReviewDean.documents}" size="3">
                      ...
                      <tr>
                        <td style="text-align:center;">
                          <h:selectOneRadio id="radio_applicationConfirmation" style="border-left:0px;border-right:0px;" layout="lineDirection" value="#{appReviewDean.applicationConfirmation}">
              ...
              <table width="740" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  ...
                  <td style="text-align:right;padding:3px 10px 1px 0px;">
                    <h:commandButton id="button_submit" action="#{appReviewDean.submit}" value="Submit" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
            </div>
