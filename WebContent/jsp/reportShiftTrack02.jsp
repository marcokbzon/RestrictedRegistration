          ...
          <tr>
            <td>
              <table width="798" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td height="25px" colspan="4" class="print_section">&nbsp;Shifts By Institution</td>
                </tr>
                <tr>
                  <td colspan="4">&nbsp;</td>
                </tr>
                <tr class="center">
                  <td colspan="4" class="center" width="700">
                    <h:dataTable id="table_shifts" value="#{shiftByInstitutionBean.shiftDM}" var="iList"
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{iList.numberOfShifts}"/>
                        <f:facet name="footer"><h:outputText value="#{adminShiftsByInstitutionReportRQ.totalShifts}" /></f:facet>
                      </h:column>

                      <h:column>
                        <f:facet name="header"><h:outputText value="Hours" /></f:facet>
                        <h:outputText value="#{iList.numberOfHours}"/>
                        <f:facet name="footer"><h:outputText value="#{adminShiftsByInstitutionReportRQ.totalHours}" /></f:facet>
                      </h:column>
                    </h:dataTable>
                  </td>
                </tr>
