...
<html>
  ...
  <body>
    <f:view>
      <h:form id="form_adminCPSOapprovedApps">
        <div id="container">
          <div id="topstatus">
          ...
          <div id="glocontainer1">
            <div id="titlepage1"> Application Listing
              <div id="hlp1">&nbsp;</div>
            </div>
                  ...
                  <td valign="top" width="95%">
                    <table width="100%" cellpadding="0" cellspacing="1" border="0">
                      <tr>
                        <td>
                          <div id="topcontent1">
                            <h1>CPSO APPROVED APPLICATIONS BY UNIVERSITY</h1>
                            <br />
                            ...
                            <div id="tbl"> <br/>
                              <table width="400" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                  <td>
                                    &nbsp;
                                    <h:selectOneMenu id="input_university" value="#{adminCPSOapprovedAppListSs.universityID}"
                                                     immediate="true" valueChangeListener="#{adminCPSOapprovedAppListSs.changeUniversity}"
                                                     onchange="this.form.submit( );" >
                                      <f:selectItem itemValue="" itemLabel="-Select a University-"/>
                                      <f:selectItems value="#{schoolBean.schoolList}" />
                                    </h:selectOneMenu>
                                    &nbsp;
                                    <h:commandButton id="button_go" action="#{adminCPSOapprovedAppListSs.go}" value="Go" styleClass="btn btnorange btn80" />
                                  </td>
                                </tr>
                              </table>
                              <table width="400" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                  <td>
                                    <h3>
                                      &nbsp;&nbsp;Number of Applications: <b><h:outputText value="#{adminCPSOapprovedAppListSs.listCount}" /></b>
                                    </h3>
                                  </td>
                                </tr>
                              </table>
                              ...
                              <table cellpadding="0" cellspacing="0" border="0" bgcolor="#999999" align="center">
                                <tr>
                                  <td>
                                    <h:dataTable id="table_applicationsA" value="#{adminCPSOapprovedAppListBean.applicationDM}" var="aList"
