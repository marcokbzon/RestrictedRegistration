...
<html>
  ...
  <body onload="setFocusOn( 'form_adminServiceTypeEdit:button_back' )">
    <f:view>
      <h:form id="form_adminServiceTypeEdit" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_adminServiceTypeEdit:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
              ...
              <table cellpadding="4" cellspacing="1" width="740" border="0">
                ...
                <tr>
                  ...
                  <td style="text-align:left;">
                    <h:commandButton id="button_save" action="#{adminServiceTypeSs.update}" value="Save" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
            </div>
