...
<html>
  ...
  <body>
    <f:view>
      <h:form id="form_adminAppListByUniversity">
        <div id="container">
          <div id="topstatus">
                            ...
                            <div id="tbl">
                              ...
                              <table width="400" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                  <td>
                                    &nbsp;
                                    <h:selectOneMenu id="input_university" value="#{adminAppListByUniversitySs.universityID}"
                                                     immediate="true" valueChangeListener="#{adminAppListByUniversitySs.changeUniversity}"
                                                     onchange="this.form.submit( );" >
                                      <f:selectItem itemValue="" itemLabel="-Select a University-"/>
                                      <f:selectItems value="#{schoolBean.schoolList}" />
                                    </h:selectOneMenu>
                                    &nbsp;
                                    <h:commandButton id="button_go" action="#{adminAppListByUniversitySs.go}" value="Go" styleClass="btn btnorange btn80" />
                                  </td>
                                </tr>
                                <tr>
                                  <td>
                                    <h:selectOneRadio id="input_status" value="#{adminAppListByUniversitySs.selectedStatus}"
                                                      immediate="true" valueChangeListener="#{adminAppListByUniversitySs.changeStatus}"
                                                      onclick="this.form.submit( );" >
                                      <f:selectItem itemValue="ALL" itemLabel="All"/>
                                      <f:selectItem itemValue="NEW" itemLabel="New"/>
                                      <f:selectItem itemValue="PRG" itemLabel="In Progress"/>
                                      <f:selectItem itemValue="CMP" itemLabel="Completed"/>
                                    </h:selectOneRadio>
                                  </td>
                                </tr>
                              </table>
                              <table width="400" border="0" cellspacing="0" cellpadding="3">
                                <tr>
                                  <td>
                                    <h3>
                                      &nbsp;&nbsp;Number of Applications: <b><h:outputText value="#{adminAppListByUniversitySs.listCount}" /></b>
                                    </h3>
                                  </td>
                                </tr>
                              </table>
                              <table cellpadding="0" cellspacing="0" border="0" bgcolor="#999999" align="center">
                                <tr>
                                  <td>
                                    <h:dataTable id="table_applications" value="#{adminAppListByUniversityBean.applicationDM}" var="aList"
                                                 styleClass="tbl_mainListing" headerClass="tbl_hdr"
                                                 rowClasses="tbl_oddRow, tbl_evenRow" columnClasses="tbl_col_26, tbl_col_110, tbl_col_460, tbl_col_118">
                                      <h:column>
                                      ...
                                      <h:column>
                                        <f:facet name="header"><h:outputText value="Resident / University / Institution" /></f:facet>
                                        <h:panelGroup>
                                      ...
                                      <h:column>
                                        ...
                                        <h:outputText value="#{aList.statusName}" styleClass="#{aList.statusIcon}"/>
                                      </h:column>
                                    </h:dataTable>
                                  </td>
                                </tr>
