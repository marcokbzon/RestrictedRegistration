                  ...
                  <td valign="top" width="95%">
                    <table width="100%" cellpadding="0" cellspacing="1" border="0">
                      <tr>
                        <td>
                          <div id="topcontent1">
                            <h1>APPLICATION LISTING STATUS</h1>
                            <br />
                            Below is a list of applications that require your attention for review/approval:
                            <br /><br />
                            <div id="tbl1t">
                            ...
                            <div id="tbl">
                              <br />
                              <h5>&nbsp;&nbsp;&nbsp;Application Forms Pending Approval</h5>
                              <br />
                              <table cellpadding="0" cellspacing="0" border="0" bgcolor="#999999" align="center">
                                <tr>
                                  <td>
                                    <h:dataTable id="table_reviewList" value="#{appReviewListingBean.applicationsDM}" var="aList"
                                                 styleClass="tbl_mainListing" headerClass="tbl_hdr"
                                                 rowClasses="tbl_oddRow, tbl_evenRow" columnClasses="tbl_col_26, tbl_col_110, tbl_col_328, tbl_col_88, tbl_col_118">
                                      <h:column>
                                      ...
                                      <h:column>
                                        <f:facet name="header"><h:outputText value="Resident / Application ID" /></f:facet>
                                        <h:panelGroup>
                                          <h:commandLink action="#{appReviewList.open}" value="#{aList.applicantName}">
                                      ...
                                      <h:column>
                                        ...
                                        <h:outputText value="#{aList.serviceType}"/>
                                      </h:column>

                                      <h:column>
                                        <f:facet name="header"><h:outputText value="Application Date" /></f:facet>
                                        <h:outputText value="#{aList.updatedOn}"/>
                                      </h:column>
