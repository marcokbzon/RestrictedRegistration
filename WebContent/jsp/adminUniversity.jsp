...
<html>
  ...
  <body onload="setFocusOn( 'form_adminUniversity:button_back' )">
    <f:view>
      <h:form id="form_adminUniversity" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_adminUniversity:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
          ...
          <div id="glocontainer1">
            ...
            <div id="contentpage">
              ...
              <table cellpadding="2" cellspacing="1" width="740" border="0">
                <tr>
                  <td width="363">
                    <h:commandButton id="button_edit" action="#{adminUniversitySs.editUniversity}" value="Edit" styleClass="btn btnorange btn100" />
                    &nbsp;
                    <h:commandButton id="button_delete" action="#{adminUniversitySs.deleteUniversity}" value="Delete" styleClass="btn btnorange btn100" />
                  </td>
                  <td  width="363" style="text-align:right;">
                    <h:commandButton id="button_add" action="#{adminUniversitySs.addUniversity}" value="Add" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
              ...
              <table width="740" cellpadding="0" cellspacing="0" border="0" bgcolor="#999999">
                <tr>
                  <td width="40">
                    ...
                    <h:selectOneRadio id="input_universityList"
                                      value="#{adminUniversitySs.universityID}" layout="pageDirection"
                                      styleClass="tbl_main2">
                      <f:selectItems value="#{adminUniversityBean.universityIdList}" />
                    </h:selectOneRadio>
                  </td>
                  <td width="700">
                    <h:dataTable id="table_universities" value="#{adminUniversityBean.universityDM}" var="uList"
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{uList.name_EN}"/>
                      </h:column>
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{uList.abbreviation}"/>
                      </h:column>
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{uList.enabledDesc}"/>
                      </h:column>
                    </h:dataTable>
                  </td>
                </tr>
              ...
              <table cellpadding="2" cellspacing="1" width="740" border="0">
                ...
                <tr>
                  <td colspan="2"><br />
                    To &quot;<strong>Edit</strong>&quot; or &quot;<strong>Delete</strong>&quot; a University, you must first select a record from the list.
                  </td>
                </tr>
              </table>
            </div>
