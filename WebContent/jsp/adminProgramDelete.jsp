...
<html>
  ...
  <body onload="setFocusOn( 'form_adminProgramDelete:button_back' )">
    <f:view>
      <h:form id="form_adminProgramDelete" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_adminProgramDelete:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
            ...
            <div id="contentpage">
              <table cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td class="steps">&nbsp;</td>
                  <td>
                    <h1>Are you sure you want to delete this Program?</h1>
                  </td>
                </tr>
              </table>
              <br />
              <table cellpadding="4" cellspacing="1" width="740" border="0">
                <tr>
                  <td width="150">Program Description</td>
                  <td class="capData">
                    <h:outputText id="output_description" value="#{adminProgramSs.description_EN}" />
                  </td>
                </tr>
                <tr>
                  <td width="150">Abbreviation</td>
                  <td class="capData">
                    <h:outputText id="output_abbreviation" value="#{adminProgramSs.abbreviation}" />
                  </td>
                </tr>
                <tr>
                  <td width="150">Enabled</td>
                  <td class="capData">
                    <h:outputText id="output_enabled" value="#{adminProgramSs.enabledDesc}" />
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="text-align:left;">
                    <h:commandButton id="button_save" action="#{adminProgramSs.delete}" value="Delete" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
            </div>
