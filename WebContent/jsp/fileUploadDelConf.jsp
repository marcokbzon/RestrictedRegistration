...
<html>
  ...
  <body onload="setFocusOn( 'form_deleteConfirmation:button_back' )">
    <f:view>
      <h:form id="form_deleteConfirmation" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_deleteConfirmation:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
          ...
          <div id="glocontainer1">
            ...
            <div id="breadcrumb"><h:commandLink value="Home" action="#{mainPage.view}" /> &gt; Upload Document</div>
            ...
            <div id="contentpage">
              ...
              <table cellpadding="4" cellspacing="1" width="740" border="0">
                <tr>
                  <td>
                    <h4>File was deleted successfully!
                    </h4>
                  </td>
                </tr>
              </table>
