...
<html>
  ...
  <body onload="setFocusOn( 'form_updateProfile03a:button_back' )">
    <f:view>
      <h:form id="form_updateProfile03a" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_updateProfile03a:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
          ...
          <div id="glocontainer1">
            ...
            <div id="contentpage">
              ...
              <table class="table_warning">
                <tr>
                  <%-- Change requested on 1202-Mar-12 by Susan Adair --%>
                  <%--td>You must <b>only add rotations that you have successfully completed</b>. Please be advised that this information will be verified in the application process. If it is discovered that some of your rotations are incomplete, your application will be rejected.</td--%>
                  <td><b>You can include rotations that you expect to complete prior to the commencement of Restricted Registration work.  Support for an RR application may be withdrawn if the required rotations are not successfully completed.</b></td>
                </tr>
              </table>
              <br />
              <table cellpadding="4" cellspacing="1" width="740" border="0">
                ...
                <tr>
                  ...
                  <td colspan="2" style="text-align:left;">
                    <h:commandButton id="button_save" action="#{clinicalInfoSs.create}" value="Save" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
            </div>
