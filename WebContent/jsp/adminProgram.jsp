...
<html>
  ...
  <body onload="setFocusOn( 'form_adminProgram:button_back' )">
    <f:view>
      <h:form id="form_adminProgram" onkeypress="if (event.keyCode == 13) { javascript:submitForm( 'form_adminProgram:button_back' ); return false; }; return true;">
        <div id="container">
          <div id="topstatus">
          ...
          <div id="glocontainer1">
            ...
            <div id="contentpage">
              ...
              <table cellpadding="2" cellspacing="1" width="740" border="0">
                <tr>
                  <td width="363">
                    <h:commandButton id="button_edit" action="#{adminProgramSs.editProgram}" value="Edit" styleClass="btn btnorange btn100" />
                    &nbsp;
                    <h:commandButton id="button_delete" action="#{adminProgramSs.deleteProgram}" value="Delete" styleClass="btn btnorange btn100" />
                  </td>
                  <td  width="363" style="text-align:right;">
                    <h:commandButton id="button_add" action="#{adminProgramSs.addProgram}" value="Add" styleClass="btn btnorange btn100" />
                  </td>
                </tr>
              </table>
              ...
              <table width="740" cellpadding="0" cellspacing="0" border="0" bgcolor="#999999">
                <tr>
                  <td width="40">
                    ...
                    <h:selectOneRadio id="input_programList"
                                      value="#{adminProgramSs.programID}" layout="pageDirection"
                                      styleClass="tbl_main2">
                      <f:selectItems value="#{adminProgramBean.programIdList}" />
                    </h:selectOneRadio>
                  </td>
                  <td width="700">
                    <h:dataTable id="table_programs" value="#{adminProgramBean.programDM}" var="pList"
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{pList.description_EN}"/>
                      </h:column>
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{pList.abbreviation}"/>
                      </h:column>
                      ...
                      <h:column>
                        ...
                        <h:outputText value="#{pList.enabledDesc}"/>
                      </h:column>
                    </h:dataTable>
                  </td>
                </tr>
              ...
              <table cellpadding="2" cellspacing="1" width="740" border="0">
                ...
                <tr>
                  <td colspan="2"><br />
                    To &quot;<strong>Edit</strong>&quot; or &quot;<strong>Delete</strong>&quot; a Program, you must first select a record from the list.
                  </td>
                </tr>
              </table>
            </div>
