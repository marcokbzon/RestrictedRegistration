...
public class AdminAppListByUniversityBean3 extends AbstractBean {

	@SuppressWarnings( "rawtypes" )
    DataModel applicationDM = new ListDataModel();
    private List<SelectItem> applicationIdList;

    public AdminAppListByUniversityBean3() {
        ...
        addToSession( SESSION_LIST_COUNT_REJECTED, EMPTY_STRING + counter );
