...
public class Table_InstServType extends _ParentDAO {

    private String DELETE_INSTSERVICETYPE_SQL =
            "DELETE FROM InstServType";
    private String INSERT_INSTSERVICETYPE_SQL =
            "INSERT INTO InstServType "
            + "( InstitutionID, ServiceTypeID ) "
            + "VALUES ( ?, ? )";

    public Table_InstServType() {
    }
    ...
    public void clearTable() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement( DELETE_INSTSERVICETYPE_SQL );
    ...
    public void loadTable() {
        ...
        try {
            ...
            //------------------------
            FileReader fileReader = new FileReader( SESSION_TBLXTR_PATH + SESSION_FILE_SEPARATOR + "inst_servtype.cvs" );
            ...
            while( line != null && ! line.trim().equals(EMPTY_STRING) ) {
                ...
                String serviceTypeID = line.substring( fs01 + 1 ).trim();

                //----
                preparedStatement = connection.prepareStatement( INSERT_INSTSERVICETYPE_SQL );
            ...
            System.out.println( "\nSTATUS FOR TABLE LOAD : InstServType" );
            System.out.println( "-----------------------------------------------------------" );
