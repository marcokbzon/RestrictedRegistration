...
public class Table_LHIN extends _ParentDAO {

    private String DELETE_LHIN_SQL =
            "DELETE FROM LHIN";
    private String INSERT_LHIN_SQL =
            "INSERT INTO LHIN "
            + "( LHIN_ID, Name_EN ) "
            + "VALUES ( ?, ? )";
    ...
    public void clearTable() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement( DELETE_LHIN_SQL );
    ...
    public void loadTable() {
        ...
        try {
            ...
            //------------------------
            FileReader fileReader = new FileReader( SESSION_TBLXTR_PATH + SESSION_FILE_SEPARATOR + "lhin.txt" );
            ...
            while( line != null && ! line.trim().equals(EMPTY_STRING) ) {
                ...
                String lhin_ID = line.substring( 0, fs01 ).trim();

                String name_EN = line.substring( fs01 + 1 ).trim();

                //----
                preparedStatement = connection.prepareStatement( INSERT_LHIN_SQL );

                preparedStatement.setString( 1, lhin_ID );
