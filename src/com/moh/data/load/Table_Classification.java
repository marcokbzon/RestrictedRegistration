...
public class Table_Classification extends _ParentDAO {

    private String DELETE_CLASSIFICATION_SQL =
            "DELETE FROM Classification";
    private String INSERT_CLASSIFICATION_SQL =
            "INSERT INTO Classification "
            + "( ClassificationID, Description_EN, GroupType ) "
            + "VALUES ( ?, ?, ? )";

    public Table_Classification() {
    }
    ...
    public void clearTable() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement( DELETE_CLASSIFICATION_SQL );
    ...
    public void loadTable() {
        ...
        try {
            ...
            //------------------------
            FileReader fileReader = new FileReader( SESSION_TBLXTR_PATH + SESSION_FILE_SEPARATOR + "classification.txt" );
            ...
            while( line != null && ! line.trim().equals(EMPTY_STRING) ) {
                ...
                String classificationID = line.substring( 0, fs01 ).trim();

                int fs02 = line.indexOf( FIELD_SEPARATOR, fs01 + 1 );
                String description_EN = line.substring( fs01 + 1, fs02 ).trim();

                String groupType = line.substring( fs02 + 1 ).trim();

                //----
                preparedStatement = connection.prepareStatement( INSERT_CLASSIFICATION_SQL );

                preparedStatement.setString( 1, classificationID );
            ...
            System.out.println( "\nSTATUS FOR TABLE LOAD : Classification" );
            System.out.println( "-----------------------------------------------------------" );
