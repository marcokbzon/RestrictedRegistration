...
public class Table_Country extends _ParentDAO {

    private String DELETE_COUNTRY_SQL =
            "DELETE FROM Country";
    private String INSERT_COUNTRY_SQL =
            "INSERT INTO Country "
            + "( CountryCode, Name_EN ) "
            + "VALUES ( ?, ? )";
    ...
    public void clearTable() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement( DELETE_COUNTRY_SQL );
    ...
    public void loadTable() {
        ...
        try {
            ...
            //------------------------
            FileReader fileReader = new FileReader( SESSION_TBLXTR_PATH + SESSION_FILE_SEPARATOR + "country.txt" );
            ...
            while( line != null && ! line.trim().equals(EMPTY_STRING) ) {
                ...
                String countryCode = line.substring( 0, fs01 ).trim();
