...
public class Table_Role extends _ParentDAO {

    private String DELETE_ROLE_SQL =
            "DELETE FROM Role";
    private String INSERT_ROLE_SQL =
            "INSERT INTO Role "
            + "( RoleID, Description_EN ) "
            + "VALUES ( ?, ? )";
    ...
    public void clearTable() {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement( DELETE_ROLE_SQL );
    ...
    public void loadTable() {
        ...
        try {
            ...
            //------------------------
            FileReader fileReader = new FileReader( SESSION_TBLXTR_PATH + SESSION_FILE_SEPARATOR + "role.cvs" );
            ...
            while( line != null && ! line.trim().equals(EMPTY_STRING) ) {
                ...
                String roleID = line.substring( 0, fs01 ).trim();
