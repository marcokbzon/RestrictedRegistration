...
public class PersonalInfoSSHelper extends AbstractBean {
    ...
    public PersonalInfoSSHelper() {
        logger = new Logger( this.getClass() );
        logger.debugMethod( "PersonalInfoSSHelper" );
    }
    ...
    public String updateProfile() {
        ...
        logger.debugPage( "/jsp/updateProfile01.jsp" );
        return "updateProfile01";
    }
    ...
    public String update() {
        ...
        if( visaStudentIndicator == null || visaStudentIndicator.trim().equals(EMPTY_STRING) ) {
            addErrorMessage( "error_visa_resident_required" );
        ...
        result = userDAO.updateProfile( getEmail(), firstName, lastName, gender, yearOfBirth, visaStudentIndicator, streetNumber, streetName, aptNumber, city, sPostalCode, homePhone, officePhone, cellPhone, pagerNumber );

        if( result ) {
            addToSession( SESSION_VISA_RESIDENT, visaStudentIndicator );
    ...
    public void populate() {
        ...
        setVisaStudentIndicator( ( String ) sql_result.get( "VisaResident" ) );
